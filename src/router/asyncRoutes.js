...
const userRoutes = [
  {
    ...
    meta: { title: '集市列表', roles: ['user'] }
  },
  {
    path: 'market/:id',
    name: 'MarketDetail',
    component: () => import('@/views/user/MarketDetail.vue'),
    meta: { title: '集市摊位', roles: ['user'] }
  },
  {
    path: 'booth/:id',
    name: 'BoothDetail',
    component: () => import('@/views/user/BoothDetail.vue'),
    meta: { title: '摊位详情', roles: ['user'] }
  },
  {
    path: 'cart',
    name: 'Cart',
    component: () => import('@/views/user/Cart.vue'),
    meta: { title: '购物车', roles: ['user'] }
  },
  {
    path: 'orders',
    name: 'MyOrders',
  ...
  },
  {
    ...
    meta: { title: '我的关注', roles: ['user'] }
  },
  {
    path: 'reservations',
    name: 'MyReservations',
    component: () => import('@/views/user/Reservations.vue'),
    meta: { title: '我的预定', roles: ['user'] }
  },
  {
    path: 'messages',
    name: 'UserMessages',
